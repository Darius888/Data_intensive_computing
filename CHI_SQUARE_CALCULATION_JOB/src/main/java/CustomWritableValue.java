...
//    }
    ...
    public CustomWritableValue(List<Text> familyMemberList) {
//        this.familyId = familyId;
        this.familyMemberList = familyMemberList;
    }
    public void addFamilyMember(Text familyMember){
...
//        this.totalAge.set(this.totalAge.get()+totalAge.get());
    ...
    public String toString() {
        ...
        return familyMemberList.size()+","+familyMemberList.toString()
                .replace("[","")
                .replace("]","");
    }
}
