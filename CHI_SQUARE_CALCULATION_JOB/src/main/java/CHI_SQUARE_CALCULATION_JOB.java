...
public class CHI_SQUARE_CALCULATION_JOB {
    ...
    public static void main(String[] args) throws Exception {
        ...
        job1.setReducerClass(Unique_per_review_Job.Reducer1.class);
        ...
        FileInputFormat.addInputPath(job3, new Path(out, "out1"));
        FileOutputFormat.setOutputPath(job3, new Path(out, "out2"));
        ...
        FileOutputFormat.setOutputPath(job4, new Path(out, "out3"));
        ...
        MultipleInputs.addInputPath(job5, new Path(out, "out1"),
                TextInputFormat.class, Intermediate_Job.Mapper1.class);
        MultipleInputs.addInputPath(job5, new Path(out, "out2"),
                TextInputFormat.class, Intermediate_Job.Mapper1.class);
        FileOutputFormat.setOutputPath(job5, new Path(out, "out4"));
        ...
        FileInputFormat.addInputPath(job7, new Path(out, "out3"));
        FileOutputFormat.setOutputPath(job7, new Path(out, "out6"));
        ...
        FileInputFormat.addInputPath(job9, new Path(out, "out7"));
        FileOutputFormat.setOutputPath(job9, new Path(out, "out8"));
        ...
        FileInputFormat.addInputPath(job10, new Path(out, "out8"));
        FileOutputFormat.setOutputPath(job10, new Path(out, "out9"));
        ...
        FileInputFormat.addInputPath(job15, new Path(out, "out9"));
